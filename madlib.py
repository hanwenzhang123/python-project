# I like to have [plural noun], [plural noun], and [plural noun] on my desk at all times. This helps me stay focused when I [verb]. I also keep my [noun] closed to keep [plural noun] from bothering me while I [verb]. When I’m [verb -ing], I use the [name] Technique. It’s where you spend [amount of time] [verb -ing] and then [amount of time] [verb -ing]. This makes me a(n) [adjective] worker.
...
print(f'It’s where you spend {time10} {verb11} and then {time12} {verb13}.')
